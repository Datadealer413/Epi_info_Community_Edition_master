...
{   
    ...
    /// </summary>
    public partial class NonExistingConnectionStringDialog : Epi.Data.PostgreSQL.Forms.ConnectionStringDialog
    {
        #region Constructors
        ...
        {
            this.Text = "Create a PostgreSQL database";
            lblInstructions.Text = "Enter information to create the PostgreSQL database.";
