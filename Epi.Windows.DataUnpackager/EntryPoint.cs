    ...
    class EntryPoint
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (LoadConfiguration(args))
            {
                ...
                string batch = commandLine.GetArgument("batch");
                ...
                try
                {
                    ...
                    //Epi.ImportExport.Globals.batch_CMDLine = batch;
                    //Epi.Windows.ImportExport.Dialogs.ImportEncryptedDataPackageDialog.C = true;
