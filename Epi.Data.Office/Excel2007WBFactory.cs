...
{
    /// <summary>
    /// Concrete DBFactory for MS Excel
    /// </summary>
    public class Excel2007WBFactory : IDbDriverFactory
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        public Excel2007WBFactory()
        {
        }
        ...
        public IConnectionStringGui GetConnectionStringGuiForExistingDb()
        {
            ...
            {
                return new Forms.Excel2007ExistingFileDialog();
            }
            else
            {
        ...
        public DbConnectionStringBuilder RequestNewConnection(string fileName)
        {
            ...
            cnnStringBuilder.Add("Extended Properties", "Excel 12.0 Xml;HDR=YES");
        ...
        public DbConnectionStringBuilder RequestDefaultConnection(string databaseName, string projectName = "")
        {
            try
            {
                ...
                oleDbCnnStringBuilder.Add("Extended Properties", "Excel 12.0 Xml;HDR=YES");
        ...
        {
            string Excel2007 = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=\"Excel 12.0 Xml;HDR=YES\"";
