...
namespace Epi.Data.Office
{
    ...
    /// </summary>
    public class ExcelWBFactory : IDbDriverFactory
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        public ExcelWBFactory()
        {
        }
        ...
        {
            IDbDriver instance = new ExcelWorkbook();
        ...
        public IConnectionStringGui GetConnectionStringGuiForExistingDb()
        {
            ...
            {
                return new Forms.ExcelExistingFileDialog();
            }
            else
            {
        ...
        public IConnectionStringGui GetConnectionStringGuiForNewDb()
        {
            if (Configuration.Environment == ExecutionEnvironment.WindowsApplication)
            {
                return new Forms.ExcelNewFileDialog();
            }
            else
            {
                throw new NotSupportedException("No GUI associated with current environment.");
        ...
        {
            string Excel = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source={0};Extended Properties=Excel 8.0;";
