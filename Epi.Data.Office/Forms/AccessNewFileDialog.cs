...
namespace Epi.Data.Office.Forms
{
    ...
    /// </summary>
    public partial class AccessNewFileDialog : System.Windows.Forms.Form, IConnectionStringGui 
    {
        ...
        protected virtual void OnBrowseClick()
        {
            ...
            dialog.Filter = "Microsoft Access Files (*.mdb)|*.mdb";
