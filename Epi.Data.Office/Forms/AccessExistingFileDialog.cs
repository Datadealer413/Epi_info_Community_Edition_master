...
namespace Epi.Data.Office.Forms
{
    ...
    /// </summary>
    public partial class AccessExistingFileDialog : System.Windows.Forms.Form, IConnectionStringGui
    {
        ...
        /// Constructor
        /// </summary>
        public AccessExistingFileDialog()
        {
            InitializeComponent();
        }
        ...
        protected void OnOkClick()
        {
            ...
            if (this.txtFileName.Text.EndsWith(".mdb", true, System.Globalization.CultureInfo.InvariantCulture))
            {
        ...
        protected virtual void OnBrowseClick()
        {
            ...
            dialog.Filter = "Microsoft Access 2002-2003 Files (*.mdb)|*.mdb";
            if (shouldIgnoreNonExistance)
            {
