...
{
	/// <summary>
	/// A dragable picture box to be used in MakeView's questionnaire designer
	/// </summary>
	public class DragablePictureBox : System.Windows.Forms.PictureBox, IDragable, IFieldControl 
	{
		...
		/// <summary>
		/// Overrides the picture box's OnPaint event
		/// </summary>
		...
		/// <summary>
		/// Initializes the Dragable picture box
		/// </summary>
		...
		/// <summary>
		/// Handles the mouse-move event over the picture box
		/// </summary>
		...
		/// <summary>
		/// Handles the mouse-down event of the picture box
		/// </summary>
		/// <param name="sender">.NET supplied object</param>
		/// <param name="e">.NET supplied event parameters</param>
		...
		/// <summary>
		/// Handles the mouse-leave event of the picture box
		/// </summary>
		/// <param name="sender">.NET supplied object</param>
		/// <param name="e">.NET supplied event parameters</param>
		...
		/// <summary>
		/// Handles the drag-over event of the picture box
		/// </summary>
		/// <param name="sender">.NET supplied object</param>
		/// <param name="e">.NET supplied event parameters</param>
		...
		/// <summary>
		/// Gets or sets the horizontal distance of the mouse from the edge of the picture box
		/// </summary>
		public int XOffset
		{
			get
		...
		/// <summary>
		/// Gets or sets the vertical distance of the mouse from the edge of the picture box
		/// </summary>
		public int YOffset
		{
			get
