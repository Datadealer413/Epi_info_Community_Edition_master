...
{
    partial class DeleteFileTableDialog
    {
        /// <summary>
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DeleteFileTableDialog));
            ...
            this.cbxSaveDataTables = new System.Windows.Forms.CheckBox();
            ...
            // rdbView
            // 
            resources.ApplyResources(this.rdbView, "rdbView");
            this.rdbView.Name = "rdbView";
            this.rdbView.Click += new System.EventHandler(this.RadioButtonClick);
            // 
            // rdbTable
            // 
            resources.ApplyResources(this.rdbTable, "rdbTable");
            this.rdbTable.Name = "rdbTable";
            this.rdbTable.Click += new System.EventHandler(this.RadioButtonClick);
            // 
            // rdbFiles
            // 
            this.rdbFiles.Checked = true;
            resources.ApplyResources(this.rdbFiles, "rdbFiles");
            this.rdbFiles.Name = "rdbFiles";
            this.rdbFiles.TabStop = true;
            this.rdbFiles.Click += new System.EventHandler(this.RadioButtonClick);
            // 
            // btnEllipse
            // 
            ...
            resources.GetString("cmbTableName.Items"),
            resources.GetString("cmbTableName.Items1"),
            resources.GetString("cmbTableName.Items2")});
            resources.ApplyResources(this.cmbTableName, "cmbTableName");
            this.cmbTableName.Name = "cmbTableName";
            this.cmbTableName.SelectedValueChanged += new System.EventHandler(this.TableNameValidate);
            this.cmbTableName.TextChanged += new System.EventHandler(this.TableNameValidate);
            this.cmbTableName.Leave += new System.EventHandler(this.TableNameValidate);
            // 
            // lblTableName
            // 
            ...
            // cbxSaveDataTables
            // 
            resources.ApplyResources(this.cbxSaveDataTables, "cbxSaveDataTables");
            this.cbxSaveDataTables.Name = "cbxSaveDataTables";
            // 
            // lblDatabase
            // 
            ...
            // lblDataFormat
            // 
            resources.ApplyResources(this.lblDataFormat, "lblDataFormat");
            this.lblDataFormat.Name = "lblDataFormat";
            // 
            // cmbDataFormats
            // 
            this.cmbDataFormats.FormattingEnabled = true;
            ...
            this.Controls.Add(this.cbxSaveDataTables);
		...
		private System.Windows.Forms.CheckBox cbxSaveDataTables;
