...
namespace Epi.Windows.Analysis.Dialogs
{
	...
	/// </summary>
    public partial class LinearRegressionDialog : CommandDesignDialog
    {
        #region Constructor
        ...
        public LinearRegressionDialog(Epi.Windows.Analysis.Forms.AnalysisMainForm frm)
            : base(frm)
        {
            InitializeComponent();
            Construct();
        ...
        protected override void GenerateCommand()
        {
            ...
            sb.Append(CommandNames.REGRESS);
            ...
            //sb.Append( StringLiterals.SPACE ).Append( cmbOutcome.Text );
            //sb.Append(StringLiterals.SPACE);
            //if (cbxMatch.Checked)
            //{
            //    sb.Append("MATCHVAR = ");
            //    foreach (string s in this.lbxOther.Items)
            //    {
            //        sb.Append(s).Append(StringLiterals.SPACE);
            //    }
            //}
            //else if (lbxOther.Items.Count > 0)
            //{
            //    sb.Append("STRATAVAR = ");
            //    foreach (string s in this.lbxOther.Items)
            //    {
        ...
        protected override bool ValidateInput()
        {
            ...
            //if (string.IsNullOrEmpty(cmbOutcome.ToString())) 
        ...
        {
            if (cmbOther.Text != StringLiterals.SPACE)
            {
                string s = cmbOther.Text;
        ...
        {
            System.Diagnostics.Process.Start("http://www.cdc.gov/epiinfo/user-guide/command-reference/analysis-commands-regress.html");
        }
