namespace Epi.Windows.Analysis.Dialogs
{
    partial class MatchDialog
    {
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MatchDialog));
            this.btnHelp = new System.Windows.Forms.Button();
            this.btnClear = new System.Windows.Forms.Button();
            this.btnCancel = new System.Windows.Forms.Button();
            this.btnOK = new System.Windows.Forms.Button();
            this.lbxMatchVars = new System.Windows.Forms.ListBox();
            this.cbxMatch = new System.Windows.Forms.CheckBox();
            this.picHeight = new System.Windows.Forms.PictureBox();
            this.cmbMatchVar = new System.Windows.Forms.ComboBox();
            this.lblMatchVar = new System.Windows.Forms.Label();
            this.cmbOutcomeVar = new System.Windows.Forms.ComboBox();
            this.lblOutcomeVar = new System.Windows.Forms.Label();
            this.lblWeight = new System.Windows.Forms.Label();
            this.cmbExpVar = new System.Windows.Forms.ComboBox();
            this.lblExpVar = new System.Windows.Forms.Label();
            ...
            // lbxMatchVars
            // 
            resources.ApplyResources(this.lbxMatchVars, "lbxMatchVars");
            this.lbxMatchVars.Name = "lbxMatchVars";
            this.lbxMatchVars.TabStop = false;
            this.lbxMatchVars.SelectedIndexChanged += new System.EventHandler(this.lbxMatchVars_SelectedIndexChanged);
            // 
            // cbxMatch
            // 
            this.cbxMatch.Checked = true;
            this.cbxMatch.CheckState = System.Windows.Forms.CheckState.Checked;
            resources.ApplyResources(this.cbxMatch, "cbxMatch");
            this.cbxMatch.Name = "cbxMatch";
            this.cbxMatch.CheckedChanged += new System.EventHandler(this.SomethingChanged);
            // 
            // picHeight
            // 
            ...
            // cmbMatchVar
            // 
            resources.ApplyResources(this.cmbMatchVar, "cmbMatchVar");
            this.cmbMatchVar.Name = "cmbMatchVar";
            this.cmbMatchVar.SelectedIndexChanged += new System.EventHandler(this.cmbMatchVar_SelectedIndexChanged);
            // 
            // lblMatchVar
            // 
            this.lblMatchVar.FlatStyle = System.Windows.Forms.FlatStyle.System;
            resources.ApplyResources(this.lblMatchVar, "lblMatchVar");
            this.lblMatchVar.Name = "lblMatchVar";
            // 
            // cmbOutcomeVar
            // 
            resources.ApplyResources(this.cmbOutcomeVar, "cmbOutcomeVar");
            this.cmbOutcomeVar.Name = "cmbOutcomeVar";
            this.cmbOutcomeVar.SelectedIndexChanged += new System.EventHandler(this.cmbOutcomeVar_SelectedIndexChanged);
            // 
            // lblOutcomeVar
            // 
            ...
            // cmbExpVar
            // 
            resources.ApplyResources(this.cmbExpVar, "cmbExpVar");
            this.cmbExpVar.Name = "cmbExpVar";
            this.cmbExpVar.SelectedIndexChanged += new System.EventHandler(this.cmbExpVar_SelectedIndexChanged);
            // 
            // lblExpVar
            // 
            this.lblExpVar.FlatStyle = System.Windows.Forms.FlatStyle.System;
            resources.ApplyResources(this.lblExpVar, "lblExpVar");
            this.lblExpVar.Name = "lblExpVar";
            // 
            // cmbWeight
            // 
            ...
            this.Controls.Add(this.lbxMatchVars);
            this.Controls.Add(this.cbxMatch);
            this.Controls.Add(this.picHeight);
            this.Controls.Add(this.cmbMatchVar);
            this.Controls.Add(this.lblMatchVar);
            this.Controls.Add(this.cmbOutcomeVar);
            ...
            this.Load += new System.EventHandler(this.MatchDialog_Load);
		...
		private System.Windows.Forms.ListBox lbxMatchVars;
		private System.Windows.Forms.CheckBox cbxMatch;
		private System.Windows.Forms.PictureBox picHeight;
		private System.Windows.Forms.ComboBox cmbMatchVar;
		private System.Windows.Forms.Label lblMatchVar;
		private System.Windows.Forms.ComboBox cmbOutcomeVar;
		private System.Windows.Forms.Label lblOutcomeVar;
		private System.Windows.Forms.Label lblWeight;
		private System.Windows.Forms.ComboBox cmbExpVar;
		private System.Windows.Forms.Label lblExpVar;
