...
{
	/// <summary>
	/// Dialog for Delete Records command
	/// </summary>
    public partial class DeleteRecordsDialog : CommandDesignDialog
	{
		#region Constructor
		...
		private void ClickHandler(object sender, System.EventArgs e)
		{
            ...
            //{
            //    txtRecAffected.Text += btn.Text;
            //}
            //else
            //{
            //    txtRecAffected.Text += (string)btn.Tag;
            //}
            //txtRecAffected.Focus();
            //txtRecAffected.SelectionStart = txtRecAffected.TextLength; 
		...
		private void DeleteRecordsDialog_Load(object sender, System.EventArgs e)
		{
			LoadVariables();
		}
        ...
        {
            System.Diagnostics.Process.Start("http://www.cdc.gov/epiinfo/user-guide/command-reference/analysis-commands-delete-records.html");
        }
        ...
        {
            Regex valid = new Regex("[A-Z,a-z,0-9,_,(.),(+),(-),\\[,\\]]+ *[<>=]+ *[\",A-Z,a-z,0-9,_,(.),(-),(+),\"]+");
            return (valid.Match(expression).Success);

        }
        //private bool ValidExpression(string expression)
        //{
        //    // The expression must contain a LHS operand and a RHS operand and a comparison operator

        //    string[] exp = expression.Split(new char[] { ' ', '<', '>', '=' });
        //    if (exp.GetUpperBound(0) < 1)   // doesn't have 2 operands
        //    {
        //        return false;
        //    }
        ...
        private void LoadVariables()
		{
            ...
            //cmbAvailableVar.DataSource = dv;
            //cmbAvailableVar.DisplayMember = ColumnNames.NAME;
            //cmbAvailableVar.ValueMember = ColumnNames.NAME;
