...
{
    partial class DefineVariableDialog : CommandDesignDialog
    {
        /// <summary>
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DefineVariableDialog));
            this.btnHelp = new System.Windows.Forms.Button();
            this.btnCancel = new System.Windows.Forms.Button();
            this.btnOK = new System.Windows.Forms.Button();
            this.btnClear = new System.Windows.Forms.Button();
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            this.lblDLLObjectDef = new System.Windows.Forms.Label();
            this.txtDLLObjectDef = new System.Windows.Forms.TextBox();
            this.cmbVarType = new Epi.Windows.Controls.LocalizedComboBox();
            this.lblVarType = new System.Windows.Forms.Label();
            this.rdbPermanent = new System.Windows.Forms.RadioButton();
            ...
            this.lblVarNameErr = new System.Windows.Forms.Label();
            ...
            // lblDLLObjectDef
            // 
            resources.ApplyResources(this.lblDLLObjectDef, "lblDLLObjectDef");
            this.lblDLLObjectDef.Name = "lblDLLObjectDef";
            // 
            // txtDLLObjectDef
            // 
            resources.ApplyResources(this.txtDLLObjectDef, "txtDLLObjectDef");
            this.txtDLLObjectDef.Name = "txtDLLObjectDef";
            this.txtDLLObjectDef.TextChanged += new System.EventHandler(this.txtDLLObjectDef_TextChanged);
            // 
            // cmbVarType
            // 
            ...
            // rdbPermanent
            // 
            resources.ApplyResources(this.rdbPermanent, "rdbPermanent");
            this.rdbPermanent.Name = "rdbPermanent";
            this.rdbPermanent.Tag = "PERMANENT";
            // 
            // rdbGlobal
            // 
            resources.ApplyResources(this.rdbGlobal, "rdbGlobal");
            this.rdbGlobal.Name = "rdbGlobal";
            this.rdbGlobal.Tag = "GLOBAL";
            // 
            // rdbStandard
            // 
            this.rdbStandard.Checked = true;
            resources.ApplyResources(this.rdbStandard, "rdbStandard");
            this.rdbStandard.Name = "rdbStandard";
            this.rdbStandard.TabStop = true;
            this.rdbStandard.Tag = "STANDARD";
            // 
            // lblVarName
            // 
            ...
            this.txtVarName.Leave += new System.EventHandler(this.txtVarName_Leave);
            // 
            // gbxScope
            // 
            ...
            // lblVarNameErr
            // 
            resources.ApplyResources(this.lblVarNameErr, "lblVarNameErr");
            this.lblVarNameErr.Name = "lblVarNameErr";
            // 
            // DefineVariableDialog
            // 
            resources.ApplyResources(this, "$this");
            this.CancelButton = this.btnCancel;
            this.Controls.Add(this.lblVarNameErr);
            this.Controls.Add(this.btnSaveOnly);
            this.Controls.Add(this.lblVarName);
            this.Controls.Add(this.txtVarName);
            this.Controls.Add(this.gbxScope);
        ...
        private System.Windows.Forms.RadioButton rdbPermanent;
        ...
        private System.Windows.Forms.Label lblDLLObjectDef;
        private System.Windows.Forms.TextBox txtDLLObjectDef;
        private System.Windows.Forms.Label lblVarNameErr;
    }
}