...
namespace Epi.Windows.MakeView.Dialogs.FieldDefinitionDialogs
{
    ...
    public partial class DateTimeFieldDefinition : PatternableTextFieldDefinition
	{
		#region Fields
		...
		private void PopulatePatterns()
		{
			...
			patterns.RowFilter = "DataTypeId = " + ((int) DataType.DateTime).ToString();
		...
		public DateTimeFieldDefinition(MainForm frm, Page page) : base(frm)
		{
			InitializeComponent();
        ...
        public DateTimeFieldDefinition(MainForm frm, DateTimeField field) : base(frm)
		{
			InitializeComponent();
