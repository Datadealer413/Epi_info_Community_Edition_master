...
namespace Epi.Windows.MakeView.Dialogs.FieldDefinitionDialogs
{
    ...
    public partial class PhoneNumberFieldDefinition : PatternableTextFieldDefinition
	{
		#region	Fields
		private PhoneNumberField field;
		#endregion	//Fields
		...
		private void PopulatePatterns()
		{
			...
			patterns.RowFilter = "DataTypeId = " + ((int) DataType.PhoneNumber).ToString();
		...
		private void LoadFormData()
		{
            ...
            {   //set a default phone number pattern
                //cbxPattern.Text = "###-###-####";
        ...
        /// </summary>
        public PhoneNumberFieldDefinition()
        {
            InitializeComponent();
        }
		/// <summary>
        ...
        public PhoneNumberFieldDefinition(MainForm frm, Page page) : base(frm)
		{
			InitializeComponent();
