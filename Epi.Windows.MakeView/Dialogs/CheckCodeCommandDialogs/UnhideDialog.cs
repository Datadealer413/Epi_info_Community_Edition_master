...
namespace Epi.Windows.MakeView.Dialogs.CheckCodeCommandDialogs
{
	...
	/// </summary>
    public partial class UnhideDialog : CheckCodeDesignDialog
    {
        #region Constructors       
        ...
        /// <summary>
        /// Constructor for the Unhide dialog
        /// </summary>
        /// <param name="frm">The main form</param>
		public UnhideDialog(MainForm frm) : base(frm)
        {
        ...
        {
            Output = CommandNames.UNHIDE + StringLiterals.SPACE;            
//          Output = "UNHIDE ";
        ...
        {
            System.Diagnostics.Process.Start("http://www.cdc.gov/epiinfo/user-guide/command-reference/check-commands-unhide.html");
        }
