...
namespace Epi.Windows.MakeView.Dialogs.CheckCodeCommandDialogs
{
	...
	/// </summary>
    public partial class UnhighlightDialog : CheckCodeDesignDialog
    {
        #region Constructors
        ...
        public UnhighlightDialog(MainForm frm)
            : base(frm)
        {
        ...
        {
            Output = CommandNames.UNHIGHLIGHT + StringLiterals.SPACE;            
        ...
        {
            System.Diagnostics.Process.Start("http://www.cdc.gov/epiinfo/user-guide/command-reference/check-commands-unhighlight.html");
        }
    }
}
