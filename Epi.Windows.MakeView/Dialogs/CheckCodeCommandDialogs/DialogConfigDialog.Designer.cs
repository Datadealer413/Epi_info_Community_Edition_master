namespace Epi.Windows.MakeView.Dialogs.CheckCodeCommandDialogs
{
    partial class DialogConfigDialog
    {
		...
		private void InitializeComponent()
		{
            ...
            this.rdbListValues.Click += new System.EventHandler(this.RadioButtonClick);
            // 
            // rdbGetVariable
            // 
            resources.ApplyResources(this.rdbGetVariable, "rdbGetVariable");
            this.rdbGetVariable.Name = "rdbGetVariable";
            this.rdbGetVariable.Click += new System.EventHandler(this.RadioButtonClick);
            // 
            // rdbSimple
            // 
            ...
            this.Name = "DialogConfigDialog";
            this.ShowInTaskbar = false;
            this.Load += new System.EventHandler(this.DialogConfigDialog_Load);
