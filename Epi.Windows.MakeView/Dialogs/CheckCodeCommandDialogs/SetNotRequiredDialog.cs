...
namespace Epi.Windows.MakeView.Dialogs.CheckCodeCommandDialogs
{
	...
	/// </summary>
    public partial class SetNotRequiredDialog : CheckCodeDesignDialog
    {
        #region Constructors
        ...
        public SetNotRequiredDialog(MainForm frm) : base(frm)
		{
			InitializeComponent();
        }
        ...
        {
            Output = CommandNames.SET_NOT_REQUIRED + StringLiterals.SPACE;
