...
namespace Epi.Windows.MakeView.Dialogs.CheckCodeCommandDialogs
{
	...
	/// </summary>
    public partial class SetRequiredDialog : CheckCodeDesignDialog
    {
        #region Constructors
        ...
        public SetRequiredDialog(MainForm frm) : base(frm)
		{
			InitializeComponent();
        }
        ...
        {
            Output = CommandNames.SET_REQUIRED + StringLiterals.SPACE;
        ...
        {
            System.Diagnostics.Process.Start("http://www.cdc.gov/epiinfo/user-guide/command-reference/check-commands-set-required.html");
        }
        ...
        public override View View
        {
            set
            {
                foreach (Fields.Field field in value.Fields)
                {
                    ...
                    if (field is Fields.RenderableField)
                    {
